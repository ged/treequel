...
module Treequel::TestConstants # :nodoc:all
	...
	unless defined?( TEST_HOST )
		...
		TEST_HOSTS_DN_PAIR   = "#{TEST_HOSTS_DN_ATTR}=#{TEST_HOSTS_DN_VALUE}"
		TEST_HOSTS_DN        = "#{TEST_HOSTS_DN_PAIR},#{TEST_BASE_DN}"

		TEST_PEOPLE_DN_ATTR  = 'ou'
		TEST_PEOPLE_DN_VALUE = 'People'
		TEST_PEOPLE_DN_PAIR  = "#{TEST_PEOPLE_DN_ATTR}=#{TEST_PEOPLE_DN_VALUE}"
		TEST_PEOPLE_DN       = "#{TEST_PEOPLE_DN_PAIR},#{TEST_BASE_DN}"

		TEST_PERSON_DN_ATTR  = 'uid'
		TEST_PERSON_DN_VALUE = 'arogers'
		TEST_PERSON_DN_PAIR  = "#{TEST_PERSON_DN_ATTR}=#{TEST_PERSON_DN_VALUE}"
		TEST_PERSON_DN       = "#{TEST_PERSON_DN_PAIR},#{TEST_PEOPLE_DN}"
